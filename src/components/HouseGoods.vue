  	...
  	<div class="second">
  		<div class="todayTopick">
			...
			<el-row class="el-row-img" :gutter="10">
				<el-col :span="12">
					<img src="../assets/imgs/HouseGoods/topick-1.jpg" alt="" class="topick-img1">
				</el-col>
				<el-col :span="12">
					<img src="../assets/imgs/HouseGoods/topick-2.jpg" alt="" class="topick-img1">
				</el-col>
			</el-row>
		</div>
		<div class="cup">
  			<el-row>
		  		<el-col :span="24">
		  			<div class="desc">家具</div>
		  		</el-col>
		  	</el-row>
		  	<el-row class="cup-img" :gutter="10">
		  		<el-col :span="12">
		  			<div>
		  			    <img src="../assets/imgs/HouseGoods/house-1.jpg" alt="">	
		  		...
		  		<el-col :span="12">
		  			<div>
		  				<img src="../assets/imgs/HouseGoods/house-2.jpg" alt="">
		  	...
		  	<el-row class="cup-img" :gutter="10">
		  		<el-col :span="12">
		  			<div>
		  			    <img src="../assets/imgs/houseGoods/house-3.jpg" alt="">	
		  		...
		  		<el-col :span="12">
		  			<div>
		  				<img src="../assets/imgs/houseGoods/house-4.jpg" alt="">
		  	...
		  	<el-row class="cup-img" :gutter="10">
		  		<el-col :span="12">
		  			<div>
		  			    <img src="../assets/imgs/houseGoods/house-5.jpg" alt="">	
		  		...
		  		<el-col :span="12">
		  			<div>
		  				<img src="../assets/imgs/houseGoods/house-6.jpg" alt="">
		  				<p class="cup-desc">浮雕小天使直口玻璃杯</p>
		  				<p class="cup-desc">精工限量手作 匠心独具</p>
...
export default {
  ...
  data(){
  	return{//轮播图图片自适应高度,思路:获取当前图片的高度然后赋给block外部容器的高度，然后flex布局容器里面的图片居中
  		items:[
  		    {
  		    	url:require('../assets/imgs/HouseGoods/carousel-1.jpg')
  		    },
  		    {
  		    	url:require('../assets/imgs/HouseGoods/carousel-2.jpg')
  		    },
  		    {
  		    	url:require('../assets/imgs/HouseGoods/carousel-3.jpg')
  		    },
  		    {
  		    	url:require('../assets/imgs/HouseGoods/carousel-5.jpg')
  		    }
  		],
  		imgHeight:200
  	}
